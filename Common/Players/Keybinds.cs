...
namespace AdvancedControls.Common.Players {
    public class KeyBindPlayer : ModPlayer {
        ...
        public override void SetControls() {
            ...
            if (!conf.scrollDuringItemUse || (!conf.scrollEntireInventory && Player.selectedItem >= 10) || (Player.itemAnimation == 0 && Player.ItemTimeIsZero && Player.reuseDelay == 0) || theorheticalOffset == 0 || Main.playerInventory || Main.mapFullscreen) {
                valuesChanged = false;
                return;
            }
